...
#define DC_HANSBURG_CONFIG_ENABLE_NONE				0
#define DC_HANSBURG_CONFIG_ENABLE_CONTROL_X			(1 << 0)
#define DC_HANSBURG_CONFIG_ENABLE_CONTROL_Y			(1 << 1)
#define DC_HANSBURG_CONFIG_ENABLE_CONTROL_Z			(1 << 2)
#define DC_HANSBURG_CONFIG_ENABLE_DOUBLE_AIR		(1 << 3)	
#define DC_HANSBURG_CONFIG_ENABLE_DOUBLE_EDGE		(1 << 4)
#define DC_HANSBURG_CONFIG_ENABLE_DOUBLE_OBJECT		(1 << 5)
#define DC_HANSBURG_CONFIG_ENABLE_DOUBLE_WALL		(1 << 6)
...
#define DC_HANSBURG_DEFAULT_CONFIG						DC_HANSBURG_CONFIG_ENABLE_CONTROL_Y | DC_HANSBURG_CONFIG_ENABLE_DOUBLE_AIR | DC_HANSBURG_CONFIG_ENABLE_DOUBLE_EDGE | DC_HANSBURG_CONFIG_ENABLE_DOUBLE_OBJECT | DC_HANSBURG_CONFIG_ENABLE_DOUBLE_WALL
...
#define DC_HANSBURG_MEMBER_CONFIG						DC_HANSBURG_BASE_ID + 3
