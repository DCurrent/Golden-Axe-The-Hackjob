...
#import "data/scripts/com/soun0009.h"      //Sound player.
#import "data/scripts/com/rnd0001.h"       //Random number generator.
#import "data/scripts/com/path0001.h"      //Get file path of entity.
...
int soun0005(void vEnt, int iGrp, int fSnd, float fProb, char cSFol, int iTime)
{
    ...
    iSnd:   Sound within group. If -1, random sound is choosen.
	...
	*/
	...
	if(fProb >= rnd0001(0, 100, 0,0,0,0) && vEnt)							//Probability met and entity confirmed?
	{
