...
#define DC_HUD_PLAYER_HP_METER_BLOCK_MARGIN_LEFT	0
#define DC_HUD_PLAYER_HP_METER_BLOCK_MARGIN_RIGHT	0
...
#define DC_HUD_PLAYER_ICON_MARGIN_LEFT	0
#define DC_HUD_PLAYER_ICON_MARGIN_RIGHT	0
#define DC_HUD_PLAYER_ICON_BORDER		1
#define DC_HUD_PLAYER_ICON_PADDDING		0
