...
#define DC_DISNEY_CONDITION_DELAY					(1 << 3)
#define DC_DISNEY_CONDITION_FALL					(1 << 4)
#define DC_DISNEY_CONDITION_GRAB_ELIGIBLE			(1 << 5)
#define DC_DISNEY_CONDITION_GRAB_IMMUNE				(1 << 6)
#define DC_DISNEY_CONDITION_HEALTH_PORTION			(1 << 7)
#define DC_DISNEY_CONDITION_HEALTH_VALUE			(1 << 8)
#define DC_DISNEY_CONDITION_HEIGHT_DIFFERENCE		(1 << 9)
#define DC_DISNEY_CONDITION_HEIGHT_VALUE			(1 << 10)
#define DC_DISNEY_CONDITION_HOSTILE					(1 << 11)
#define DC_DISNEY_CONDITION_MODEL_DEFAULT			(1 << 12)
#define DC_DISNEY_CONDITION_MP_PORTION				(1 << 13)
#define DC_DISNEY_CONDITION_MP_VALUE				(1 << 14)
#define DC_DISNEY_CONDITION_RANDOM					(1 << 15)
#define DC_DISNEY_CONDITION_RANGE					(1 << 16)
#define DC_DISNEY_CONDITION_SUBTYPE					(1 << 17)
#define DC_DISNEY_CONDITION_TYPE					(1 << 18)
#define DC_DISNEY_CONDITION_WALKOFF					(1 << 19)
...
#define DC_DISNEY_DEFAULT_CONDITION_ACTING_DELAY					100
#define DC_DISNEY_DEFAULT_CONDITION_ACTING_DELAY_EVAL				DC_DISNEY_CONDITION_EVAL_TRUE
...
#define DC_DISNEY_DEFAULT_CONDITION_ACTING_RANDOM					100
#define DC_DISNEY_DEFAULT_CONDITION_ACTING_RANDOM_EVAL				DC_DISNEY_CONDITION_EVAL_TRUE
...
#define DC_DISNEY_DEFAULT_CONDITION_TARGET_DELAY					100
#define DC_DISNEY_DEFAULT_CONDITION_TARGET_DELAY_EVAL				DC_DISNEY_CONDITION_EVAL_TRUE
...
#define DC_DISNEY_DEFAULT_CONDITION_TARGET_RANDOM					100
#define DC_DISNEY_DEFAULT_CONDITION_TARGET_RANDOM_EVAL				DC_DISNEY_CONDITION_EVAL_TRUE
...
#define DC_DISNEY_MEMBER_CONDITION_ACTING_DELAY						DC_DISNEY_BASE_ID + 7
#define DC_DISNEY_MEMBER_CONDITION_ACTING_DELAY_EVAL				DC_DISNEY_BASE_ID + 8
#define DC_DISNEY_MEMBER_CONDITION_ACTING_FALL						DC_DISNEY_BASE_ID + 9
#define DC_DISNEY_MEMBER_CONDITION_ACTING_FALL_EVAL					DC_DISNEY_BASE_ID + 10
#define DC_DISNEY_MEMBER_CONDITION_ACTING_GRAB_ELIGIBLE				DC_DISNEY_BASE_ID + 11
#define DC_DISNEY_MEMBER_CONDITION_ACTING_GRAB_ELIGIBLE_EVAL		DC_DISNEY_BASE_ID + 12
#define DC_DISNEY_MEMBER_CONDITION_ACTING_GRAB_IMMUNE				DC_DISNEY_BASE_ID + 13
#define DC_DISNEY_MEMBER_CONDITION_ACTING_GRAB_IMMUNE_EVAL			DC_DISNEY_BASE_ID + 14
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEALTH_PORTION			DC_DISNEY_BASE_ID + 15
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEALTH_PORTION_EVAL		DC_DISNEY_BASE_ID + 16
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEALTH_VALUE				DC_DISNEY_BASE_ID + 17
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEALTH_VALUE_EVAL			DC_DISNEY_BASE_ID + 18
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEIGHT_DIFFERENCE			DC_DISNEY_BASE_ID + 19
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEIGHT_DIFFERENCE_EVAL	DC_DISNEY_BASE_ID + 20
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEIGHT_VALUE				DC_DISNEY_BASE_ID + 21
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HEIGHT_VALUE_EVAL			DC_DISNEY_BASE_ID + 22
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HOSTILE					DC_DISNEY_BASE_ID + 23
#define DC_DISNEY_MEMBER_CONDITION_ACTING_HOSTILE_EVAL				DC_DISNEY_BASE_ID + 24
#define DC_DISNEY_MEMBER_CONDITION_ACTING_MODEL_DEFAULT				DC_DISNEY_BASE_ID + 25
#define DC_DISNEY_MEMBER_CONDITION_ACTING_MODEL_DEFAULT_EVAL		DC_DISNEY_BASE_ID + 26
#define DC_DISNEY_MEMBER_CONDITION_ACTING_MP_PORTION				DC_DISNEY_BASE_ID + 27
#define DC_DISNEY_MEMBER_CONDITION_ACTING_MP_PORTION_EVAL			DC_DISNEY_BASE_ID + 28
#define DC_DISNEY_MEMBER_CONDITION_ACTING_MP_VALUE					DC_DISNEY_BASE_ID + 29
#define DC_DISNEY_MEMBER_CONDITION_ACTING_MP_VALUE_EVAL				DC_DISNEY_BASE_ID + 30
#define DC_DISNEY_MEMBER_CONDITION_ACTING_RANDOM					DC_DISNEY_BASE_ID + 31
#define DC_DISNEY_MEMBER_CONDITION_ACTING_RANDOM_EVAL				DC_DISNEY_BASE_ID + 32
#define DC_DISNEY_MEMBER_CONDITION_ACTING_RANGE						DC_DISNEY_BASE_ID + 33
#define DC_DISNEY_MEMBER_CONDITION_ACTING_RANGE_EVAL				DC_DISNEY_BASE_ID + 34
#define DC_DISNEY_MEMBER_CONDITION_ACTING_SUBTYPE					DC_DISNEY_BASE_ID + 35
#define DC_DISNEY_MEMBER_CONDITION_ACTING_SUBTYPE_EVAL				DC_DISNEY_BASE_ID + 36
#define DC_DISNEY_MEMBER_CONDITION_ACTING_TYPE						DC_DISNEY_BASE_ID + 37
#define DC_DISNEY_MEMBER_CONDITION_ACTING_TYPE_EVAL					DC_DISNEY_BASE_ID + 38
#define DC_DISNEY_MEMBER_CONDITION_ACTING_WALKOFF					DC_DISNEY_BASE_ID + 39
#define DC_DISNEY_MEMBER_CONDITION_ACTING_WALKOFF_EVAL				DC_DISNEY_BASE_ID + 40

#define DC_DISNEY_MEMBER_CONDITION_TARGET_AIR						DC_DISNEY_BASE_ID + 41
#define DC_DISNEY_MEMBER_CONDITION_TARGET_AIR_EVAL					DC_DISNEY_BASE_ID + 42
#define DC_DISNEY_MEMBER_CONDITION_TARGET_ANIMAL					DC_DISNEY_BASE_ID + 43
#define DC_DISNEY_MEMBER_CONDITION_TARGET_ANIMAL_EVAL				DC_DISNEY_BASE_ID + 44
#define DC_DISNEY_MEMBER_CONDITION_TARGET_ANIMATION					DC_DISNEY_BASE_ID + 45
#define DC_DISNEY_MEMBER_CONDITION_TARGET_ANIMATION_EVAL			DC_DISNEY_BASE_ID + 46
#define DC_DISNEY_MEMBER_CONDITION_TARGET_DELAY						DC_DISNEY_BASE_ID + 47
#define DC_DISNEY_MEMBER_CONDITION_TARGET_DELAY_EVAL				DC_DISNEY_BASE_ID + 48
#define DC_DISNEY_MEMBER_CONDITION_TARGET_FALL						DC_DISNEY_BASE_ID + 49
#define DC_DISNEY_MEMBER_CONDITION_TARGET_FALL_EVAL					DC_DISNEY_BASE_ID + 50
#define DC_DISNEY_MEMBER_CONDITION_TARGET_GRAB_ELIGIBLE				DC_DISNEY_BASE_ID + 51
#define DC_DISNEY_MEMBER_CONDITION_TARGET_GRAB_ELIGIBLE_EVAL		DC_DISNEY_BASE_ID + 52
#define DC_DISNEY_MEMBER_CONDITION_TARGET_GRAB_IMMUNE				DC_DISNEY_BASE_ID + 53
#define DC_DISNEY_MEMBER_CONDITION_TARGET_GRAB_IMMUNE_EVAL			DC_DISNEY_BASE_ID + 54
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEALTH_PORTION			DC_DISNEY_BASE_ID + 55
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEALTH_PORTION_EVAL		DC_DISNEY_BASE_ID + 56
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEALTH_VALUE				DC_DISNEY_BASE_ID + 57
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEALTH_VALUE_EVAL			DC_DISNEY_BASE_ID + 58
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEIGHT_DIFFERENCE			DC_DISNEY_BASE_ID + 59
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEIGHT_DIFFERENCE_EVAL	DC_DISNEY_BASE_ID + 60
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEIGHT_VALUE				DC_DISNEY_BASE_ID + 61
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HEIGHT_VALUE_EVAL			DC_DISNEY_BASE_ID + 62
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HOSTILE					DC_DISNEY_BASE_ID + 63
#define DC_DISNEY_MEMBER_CONDITION_TARGET_HOSTILE_EVAL				DC_DISNEY_BASE_ID + 64
#define DC_DISNEY_MEMBER_CONDITION_TARGET_MODEL_DEFAULT				DC_DISNEY_BASE_ID + 65
#define DC_DISNEY_MEMBER_CONDITION_TARGET_MODEL_DEFAULT_EVAL		DC_DISNEY_BASE_ID + 66
#define DC_DISNEY_MEMBER_CONDITION_TARGET_MP_PORTION				DC_DISNEY_BASE_ID + 67
#define DC_DISNEY_MEMBER_CONDITION_TARGET_MP_PORTION_EVAL			DC_DISNEY_BASE_ID + 68
#define DC_DISNEY_MEMBER_CONDITION_TARGET_MP_VALUE					DC_DISNEY_BASE_ID + 69
#define DC_DISNEY_MEMBER_CONDITION_TARGET_MP_VALUE_EVAL				DC_DISNEY_BASE_ID + 70
#define DC_DISNEY_MEMBER_CONDITION_TARGET_RANDOM					DC_DISNEY_BASE_ID + 71
#define DC_DISNEY_MEMBER_CONDITION_TARGET_RANDOM_EVAL				DC_DISNEY_BASE_ID + 72
#define DC_DISNEY_MEMBER_CONDITION_TARGET_RANGE						DC_DISNEY_BASE_ID + 73
#define DC_DISNEY_MEMBER_CONDITION_TARGET_RANGE_EVAL				DC_DISNEY_BASE_ID + 74
#define DC_DISNEY_MEMBER_CONDITION_TARGET_SUBTYPE					DC_DISNEY_BASE_ID + 75
#define DC_DISNEY_MEMBER_CONDITION_TARGET_SUBTYPE_EVAL				DC_DISNEY_BASE_ID + 76
#define DC_DISNEY_MEMBER_CONDITION_TARGET_TYPE						DC_DISNEY_BASE_ID + 77
#define DC_DISNEY_MEMBER_CONDITION_TARGET_TYPE_EVAL					DC_DISNEY_BASE_ID + 78
#define DC_DISNEY_MEMBER_CONDITION_TARGET_WALKOFF					DC_DISNEY_BASE_ID + 79
#define DC_DISNEY_MEMBER_CONDITION_TARGET_WALKOFF_EVAL				DC_DISNEY_BASE_ID + 80

#define DC_DISNEY_MEMBER_ENT										DC_DISNEY_BASE_ID + 81
#define DC_DISNEY_MEMBER_SWITCH_RESET								DC_DISNEY_BASE_ID + 82
#define DC_DISNEY_MEMBER_SWITCH_TYPE								DC_DISNEY_BASE_ID + 83
#define DC_DISNEY_MEMBER_TARGET										DC_DISNEY_BASE_ID + 84
#define DC_DISNEY_MEMBER_TARGET_SELECT_ANIMATION					DC_DISNEY_BASE_ID + 85
#define DC_DISNEY_MEMBER_TARGET_SELECT_METHOD						DC_DISNEY_BASE_ID + 86
#define DC_DISNEY_MEMBER_TIME_DELAY									DC_DISNEY_BASE_ID + 87
#define DC_DISNEY_MEMBER_CONDITION_FLAG_ACTING						DC_DISNEY_BASE_ID + 88
#define DC_DISNEY_MEMBER_CONDITION_FLAG_TARGET						DC_DISNEY_BASE_ID + 89
#define DC_DISNEY_MEMBER_THE_END		90			// Should always be last, with a value one higher than previous key ID.
