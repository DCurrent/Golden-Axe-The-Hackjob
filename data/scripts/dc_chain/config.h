...
#define DC_CHAIN_DEFAULT_STUN_RECOVERY_RATE		5
#define DC_CHAIN_DEFAULT_STUN_RECOVERY_TIME		100
...
#define DC_CHAIN_MEMBER_STUN_RECOVERY_LAST		DC_CHAIN_BASE_ID + 4
#define DC_CHAIN_MEMBER_STUN_RECOVERY_RATE		DC_CHAIN_BASE_ID + 5
#define DC_CHAIN_MEMBER_STUN_RECOVERY_TIME		DC_CHAIN_BASE_ID + 6
