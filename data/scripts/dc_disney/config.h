...
#define DC_DISNEY_MEMBER_TIME_DELAY									DC_DISNEY_BASE_ID + 84
#define DC_DISNEY_MEMBER_CONDITION_FLAG_ACTING						DC_DISNEY_BASE_ID + 85
#define DC_DISNEY_MEMBER_CONDITION_FLAG_TARGET						DC_DISNEY_BASE_ID + 86
#define DC_DISNEY_MEMBER_THE_END		87			// Should always be last, with a value one higher than previous key ID.
